...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } // Import the createClient function from @supabase/supabase-js
...
function fetchAthletes(_x, _x2) {
  return _fetchAthletes.apply(this, arguments);
} // Function to generate athlete profiles and append them to the contenders-container
function _fetchAthletes() {
  _fetchAthletes = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(supabaseUrl, supabaseKey) {
    var supabase, _yield$supabase$from$, data, error;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          supabase = (0, _supabaseJs.createClient)(supabaseUrl, supabaseKey);
          _context.next = 4;
          return supabase.from('url_players').select('athlete_full_name, athlete_url, games');
        case 4:
...
function displayAthletes() {
  return _displayAthletes.apply(this, arguments);
} // Call the function to display athletes after DOM content is loaded
function _displayAthletes() {
  _displayAthletes = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var supabaseUrl, supabaseKey, athletesData, contendersContainer;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          supabaseUrl = 'https://qcmzcfublrqyfgdiforw.supabase.co';
          supabaseKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InFjbXpjZnVibHJxeWZnZGlmb3J3Iiwicm9sZSI6ImFub24iLCJpYXQiOjE2OTAyMjA4NjUsImV4cCI6MjAwNTc5Njg2NX0.wTZbmgx2Z9_UZLnlUYy0kMyn2nnetIe4G06LPl5HX10';
          _context2.next = 5;
          return fetchAthletes(supabaseUrl, supabaseKey);
        case 5:
          athletesData = _context2.sent;
          contendersContainer = document.querySelector('.contender-profiles');
          athletesData.forEach(function (athlete) {
            var athleteProfile = document.createElement('div');
        ...
        case 10:
          ...
          console.error('Error fetching and displaying athletes:', _context2.t0);
        case 13:
        case "end":
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  loadScript("https://cdn.jsdelivr.net/npm/@supabase/supabase-js@1.24.0/dist/supabase.js", function () {
...
require("./contender2.js");
},{"./contender2.js":"contender2.js"}],"../../../../AppData/Roaming/nvm/v18.15.0/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
